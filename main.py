...
def explain_prediction(probability, input_dict, surname):
  ...
  Don't mention the probability of churning, or the machine learning model, or say anything like "Based on the machine learning model's prediction and top 10 most important features", just explain the prediction, also dont say anything along the lines of "I believe they are at risk of churning because..." just say "they are at risk of churning because..." and dont start it with "based on feature importance..." just go straight to the explanation. Dont restate the customers data, just use it. Dont start it with "heres an explanation", just go straight to the explanation.
  """
...
def make_predictions(input_df, input_dict):
    ...
    with col1:
        ...
        st.write(
            f"The customer has a {avg_probability * 100:.1f}% probability of churning."
        )
    with col2:
